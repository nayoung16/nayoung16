## Welcome 🤭
Hi, I'm Backend developer who designs data flow, system architecture, and scalable services.<br/><br/>
데이터 흐름과 시스템 아키텍처를 설계하는 백엔드 개발자, 김나영입니다.
  
## Projects

[**1D1S (챌린지 웹 플랫폼)**](https://1day1streak.com/) | 2026.02 ~
- 서버 운영 및 백엔드 개발
...
- 사용자 맞춤 캠핑장 추천 서비스 백엔드 및 데이터 파이프라인 개발  
...
| BOAZ 빅데이터 연합동아리 | 2024.07 ~ 2025.07 | 데이터 엔지니어링 23기, 자료연구팀 운영진 팀장 |
| GDSC Sookmyung | 2023.09 ~ 2024.06 | Spring Boot 백엔드 및 GCP 배포 경험 |
| MVP 개발지원 서포터즈 6기 | 2024.11 | Spring 기반 유저 기능 및 네이버 API 연동 |
| PLAYDATA 데이터 엔지니어링 부트캠프 | 2024.02 ~ 2024.08 | 데이터 엔지니어링 및 MLOps 과정 (960시간) |
| DACOS 데이터분석 학회 | 2022.09 ~ 2024.02 | 데이터톤 우승 및 분석 프로젝트 수행 |
| 숙명여자대학교 컴퓨터과학전공, 빅데이터전공 졸업 | 2021.03 ~ 2026.02 | 학업성적우등상 수상 |

## Awards
- 2022 숙명 소프트웨어 해커톤 최우수상 (2위)
- DACOS 데이터톤 종합우승 (1위)
